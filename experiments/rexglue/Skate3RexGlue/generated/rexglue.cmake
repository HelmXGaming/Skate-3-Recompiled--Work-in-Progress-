...
# Codegen target - run 'cmake --build . --target skate3rexglue_codegen'
# Uses the manifest to drive codegen for all modules (entrypoint + DLLs).
add_custom_target(skate3rexglue_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/skate3rexglue_manifest.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for skate3rexglue"
    VERBATIM
)
